...
- [docs/specs/](docs/specs/) — work specs. `open/` = transient, awaiting
  ...
  moves on history, 0021 defines Preview's tested Markdown dialect, 0022 makes asking before a dirty Raw exit a default-on preference, and 0023 folds Preview's sections without touching a byte.
