...
export const DEFAULTS = {
  ...
  ai: {
    /* The CLIProxyAPI instance now lives in the k3s cluster, exposed by Traefik
       as `cliproxy.k3s.lan` (namespace cliproxy, service cliproxy:8317). HTTPS
       ...
       DNS, not by CoreDNS. */
    baseUrl: "https://cliproxy.k3s.lan/v1",
    model: "gpt-5.6-sol",
    effort: "high",
