...
- [AI backend](tickets/02-ai-backend.md) — pluggable OpenAI-compatible endpoint (base URL + key + model in settings); default model `gpt-5`, configurable effort, default high.
