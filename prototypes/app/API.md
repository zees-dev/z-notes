...
```json
{
  "settings": {
    ...
    "ai": { "baseUrl": "http://127.0.0.1:8317/v1", "model": "gpt-5.6-sol",
...
```json
"ai": {
  "probe": { "baseUrl": "http://127.0.0.1:8317/v1", "model": "gpt-5.6-sol",
  ...
  "status": { "state": "ok", "model": "gpt-5.6-sol", "effort": "high",
              "message": "gpt-5.6-sol · high — http://127.0.0.1:8317/v1 answered /responses with tools and reasoning.",
...
event: ai-status
data: {"state":"unreachable","model":"gpt-5.6-sol","effort":"high",
